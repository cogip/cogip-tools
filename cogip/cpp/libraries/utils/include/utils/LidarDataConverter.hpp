...
public:
    ...
    void setTableLimitsMargin(float table_limits_margin) {
        table_limits_margin_ = table_limits_margin;
    }

    /// Set the lidar offset on X axis.
    void setLidarOffsetX(float lidar_offset_x) {
        lidar_offset_x_ = lidar_offset_x;
    }

    /// Set the lidar offset on Y axis.
    void setLidarOffsetY(float lidar_offset_y) {
...
private:
    ...
    float (*lidar_coords_)[2];                                    ///< Pointer to lidar coords memory
    ...
    float* table_limits_;                                         ///< Pointer to table limits
    float table_limits_margin_;                                   ///< Margin for table limits
    float lidar_offset_x_;                                        ///< Lidar offset on X axis
    float lidar_offset_y_;                                        ///< Lidar offset on Y axis
