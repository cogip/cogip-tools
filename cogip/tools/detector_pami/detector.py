...
from ..detector.gui import DetectorGUI
from ..detector.web import start_web
from . import logger
...
class Detector:
    ...
    def __init__(
        ...
        self.lidar: LDLidarDriver | None = None
    ...
    def start_lidar(self):
        ...
        if self.lidar_port:
            ...
            res = self.lidar.connect(str(self.lidar_port), BaudRate.BAUD_230400)
            if not res:
