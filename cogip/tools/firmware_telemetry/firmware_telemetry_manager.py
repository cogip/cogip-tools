...
from cogip.models.firmware_telemetry import TelemetryStore
...
class FirmwareTelemetryManager:
    ...
    Telemetry data is stored in a TelemetryStore and can be accessed by key name or hash.
    ...
    def get_value(self, key: str, default: float | int = 0) -> float | int:
        ...
        """
        return self.store.get_value(key, default)
