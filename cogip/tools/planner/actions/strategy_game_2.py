...
from cogip.tools.planner.actions.push_granary_crates import PushGranaryCratesAction
...
class Game2Strategy(Strategy):
    def __init__(self, planner: "Planner"):
        ...
        self.append(PushGranaryCratesAction(planner, self, weight=9_000_000.0, unit_test=False))
...
class Game2AlignStrategy(Game2Strategy):
    def __init__(self, planner: "Planner"):
        super().__init__(planner)
