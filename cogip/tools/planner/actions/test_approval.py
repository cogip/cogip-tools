...
class ApprovalStrategy(Strategy):
    def __init__(self, planner: "Planner"):
        ...
        self.append(BuildTribuneX2Action(planner, self, ConstructionAreaID.LocalBottomLarge1, 1_900_000.0))
        self.append(BuildTribuneX2Action(planner, self, ConstructionAreaID.LocalBottomLarge2, 1_800_000.0))
        self.append(BuildTribuneX2Action(planner, self, ConstructionAreaID.LocalBottomLarge3, 1_600_000.0))

        self.append(BuildTribuneX1Action(planner, self, ConstructionAreaID.LocalBottomLarge1, 900_000.0))
