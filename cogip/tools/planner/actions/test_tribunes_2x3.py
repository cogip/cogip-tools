...
from cogip.tools.planner.actions.action_align_bottom import AlignBottomAction
...
class TestTribune2x3Actions(Actions):
    def __init__(self, planner: "Planner"):
        ...
        self.append(BuildTribuneX3Action(planner, self, ConstructionAreaID.LocalBottomLarge2, 1_800_000.0))
