...
FRONT_GRIP_LEFT_SIDE_ZERO = 517
FRONT_GRIP_LEFT_CENTER_ZERO = 656
FRONT_GRIP_RIGHT_CENTER_ZERO = 642
FRONT_GRIP_RIGHT_SIDE_ZERO = 515
FRONT_AXIS_LEFT_SIDE_ZERO = 861
FRONT_AXIS_LEFT_CENTER_ZERO = 870
FRONT_AXIS_RIGHT_CENTER_ZERO = 888
FRONT_AXIS_RIGHT_SIDE_ZERO = 742
FRONT_ARM_LEFT_ZERO = 373
FRONT_ARM_RIGHT_ZERO = 321
FRONT_SCISSOR_LEFT_ZERO = 618
FRONT_SCISSOR_RIGHT_ZERO = 874
...
async def front_lift_down(planner: "Planner", speed: int = 100, timeout: int = 5000) -> float:
    await positional_motor_command(planner, PositionalActuatorEnum.FRONT_LIFT, LIFT_DOWN, speed, timeout)
    await planner.sio_ns.emit("lift", (PositionalActuatorEnum.FRONT_LIFT, LIFT_DOWN))
    return LIFT_MOVE_DURATION_SEC


async def front_lift_mid(planner: "Planner", speed: int = 100, timeout: int = 5000) -> float:
    await positional_motor_command(planner, PositionalActuatorEnum.FRONT_LIFT, LIFT_MID, speed, timeout)
    await planner.sio_ns.emit("lift", (PositionalActuatorEnum.FRONT_LIFT, LIFT_MID))
    return LIFT_MOVE_DURATION_SEC / 2


async def front_lift_up(planner: "Planner", speed: int = 100, timeout: int = 5000) -> float:
    await positional_motor_command(planner, PositionalActuatorEnum.FRONT_LIFT, LIFT_UP, speed, timeout)
    await planner.sio_ns.emit("lift", (PositionalActuatorEnum.FRONT_LIFT, LIFT_UP))
    return LIFT_MOVE_DURATION_SEC


async def back_lift_down(planner: "Planner", speed: int = 100, timeout: int = 5000) -> float:
    await positional_motor_command(planner, PositionalActuatorEnum.BACK_LIFT, LIFT_DOWN, speed, timeout)
    await planner.sio_ns.emit("lift", (PositionalActuatorEnum.BACK_LIFT, LIFT_DOWN))
    return LIFT_MOVE_DURATION_SEC


async def back_lift_mid(planner: "Planner", speed: int = 100, timeout: int = 5000) -> float:
    await positional_motor_command(planner, PositionalActuatorEnum.BACK_LIFT, LIFT_MID, speed, timeout)
    await planner.sio_ns.emit("lift", (PositionalActuatorEnum.BACK_LIFT, LIFT_MID))
    return LIFT_MOVE_DURATION_SEC / 2


async def back_lift_up(planner: "Planner", speed: int = 100, timeout: int = 5000) -> float:
    await positional_motor_command(planner, PositionalActuatorEnum.BACK_LIFT, LIFT_UP, speed, timeout)
...
async def front_scissor_left_open(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.FRONT_SCISSOR_LEFT, FRONT_SCISSOR_LEFT_ZERO + SCISSOR_OFFSET_OPEN, speed=speed, reg_only=reg_only
    )
...
async def front_scissor_left_close(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.FRONT_SCISSOR_LEFT, FRONT_SCISSOR_LEFT_ZERO + SCISSOR_OFFSET_CLOSE, speed=speed, reg_only=reg_only
    )
...
async def front_scissor_right_open(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.FRONT_SCISSOR_RIGHT, FRONT_SCISSOR_RIGHT_ZERO - SCISSOR_OFFSET_OPEN, speed=speed, reg_only=reg_only
    )
...
async def front_scissor_right_close(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.FRONT_SCISSOR_RIGHT, FRONT_SCISSOR_RIGHT_ZERO - SCISSOR_OFFSET_CLOSE, speed=speed, reg_only=reg_only
    )
...
async def back_scissor_left_open(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.BACK_SCISSOR_LEFT, BACK_SCISSOR_LEFT_ZERO + SCISSOR_OFFSET_OPEN, speed=speed, reg_only=reg_only
    )
...
async def back_scissor_left_close(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.BACK_SCISSOR_LEFT, BACK_SCISSOR_LEFT_ZERO + SCISSOR_OFFSET_CLOSE, speed=speed, reg_only=reg_only
    )
...
async def back_scissor_right_open(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.BACK_SCISSOR_RIGHT, BACK_SCISSOR_RIGHT_ZERO + SCISSOR_OFFSET_OPEN, speed=speed, reg_only=reg_only
    )
...
async def back_scissor_right_close(planner: "Planner", speed: int = 1000, reg_only: bool = False) -> float:
    planner.scservos.set(
        SCServoEnum.BACK_SCISSOR_RIGHT, BACK_SCISSOR_RIGHT_ZERO + SCISSOR_OFFSET_CLOSE, speed=speed, reg_only=reg_only
    )
