...
async def arm_right_side(planner: "Planner"):
    planner.scservos.set(SCServoEnum.ARM_RIGHT, 508)
...
async def arm_left_side(planner: "Planner"):
    planner.scservos.set(SCServoEnum.ARM_LEFT, 457)
...
async def magnet_side_left_out(planner: "Planner"):
    planner.scservos.set(SCServoEnum.MAGNET_SIDE_LEFT, 837)
...
async def arm_grip_left_hold(planner: "Planner"):
    planner.scservos.set(SCServoEnum.ARM_GRIP_LEFT, 260)
...
async def arm_grip_right_hold(planner: "Planner"):
    planner.scservos.set(SCServoEnum.ARM_GRIP_RIGHT, 955)
