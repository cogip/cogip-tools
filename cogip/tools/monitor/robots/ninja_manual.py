...
class NinjaManual:
    def __init__(self, root: QObject):
        ...
        for model in self.models:
            model.setObjectName(f"ninja_manual_{model.objectName()}")
            model.setProperty("pickable", True)

        self.window_settings = NinjaManualWindowSettings()
        self.root.setProperty("windowSettings", self.window_settings)


class NinjaManualWindowSettings(QObject):
    ...
    def windowX(self) -> int:
        return self._get_int("NinjaManualWindow/windowX")

    @windowX.setter
    def windowX(self, value: int) -> None:
        self._set_int("NinjaManualWindow/windowX", value)

    @Property(int)
    def windowY(self) -> int:
        return self._get_int("NinjaManualWindow/windowY")

    @windowY.setter
    def windowY(self, value: int) -> None:
        self._set_int("NinjaManualWindow/windowY", value)
