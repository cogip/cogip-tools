...
case ${ROBOT_ID} in
    1) # Robot
        ...
        DETECTOR_LIDAR_PORT=${ROBOT_DETECTOR_LIDAR_PORT}
        DETECTOR_MIN_DISTANCE=${ROBOT_DETECTOR_MIN_DISTANCE}
        DETECTOR_MAX_DISTANCE=${ROBOT_DETECTOR_MAX_DISTANCE}
        DETECTOR_MIN_INTENSITY=${ROBOT_DETECTOR_MIN_INTENSITY}
        DETECTOR_REFRESH_INTERVAL=${ROBOT_DETECTOR_REFRESH_INTERVAL}
    ...
    2) # Ninja
        DOCKER_TAG=ninja
        ROBOT_WIDTH=${NINJA_WIDTH}
        ROBOT_LENGTH=${NINJA_LENGTH}
        DETECTOR_LIDAR_PORT=${NINJA_DETECTOR_LIDAR_PORT}
        DETECTOR_MIN_DISTANCE=${NINJA_DETECTOR_MIN_DISTANCE}
        DETECTOR_MAX_DISTANCE=${NINJA_DETECTOR_MAX_DISTANCE}
        DETECTOR_MIN_INTENSITY=${NINJA_DETECTOR_MIN_INTENSITY}
        DETECTOR_REFRESH_INTERVAL=${NINJA_DETECTOR_REFRESH_INTERVAL}
        DETECTOR_SENSOR_DELAY=${NINJA_DETECTOR_SENSOR_DELAY}
        DETECTOR_CLUSTER_MIN_SAMPLES=${NINJA_DETECTOR_CLUSTER_MIN_SAMPLES}
        DETECTOR_CLUSTER_EPS=${NINJA_DETECTOR_CLUSTER_EPS}
        PLANNER_OBSTACLE_BB_MARGIN=${NINJA_PLANNER_OBSTACLE_BB_MARGIN}
        ;;
    [3-9]) # PAMIs
        DOCKER_TAG=pami
        ...
        DETECTOR_MIN_DISTANCE=${PAMI_DETECTOR_MIN_DISTANCE}
        DETECTOR_MAX_DISTANCE=${PAMI_DETECTOR_MAX_DISTANCE}
        DETECTOR_MIN_INTENSITY=${PAMI_DETECTOR_MIN_INTENSITY}
        DETECTOR_REFRESH_INTERVAL=${PAMI_DETECTOR_REFRESH_INTERVAL}
...
sudo sed -i "s/IP_ADDRESS_ROBOT6/${IP_ADDRESS_ROBOT6_WLAN0}/" ${MOUNT_DIR}/etc/hosts
...
sudo sed -i "s|CUSTOM_DETECTOR_LIDAR_PORT|${DETECTOR_LIDAR_PORT}|" ${MOUNT_DIR}/etc/environment
sudo sed -i "s/CUSTOM_DETECTOR_MIN_DISTANCE/${DETECTOR_MIN_DISTANCE}/" ${MOUNT_DIR}/etc/environment
sudo sed -i "s/CUSTOM_DETECTOR_MAX_DISTANCE/${DETECTOR_MAX_DISTANCE}/" ${MOUNT_DIR}/etc/environment
sudo sed -i "s/CUSTOM_DETECTOR_MIN_INTENSITY/${DETECTOR_MIN_INTENSITY}/" ${MOUNT_DIR}/etc/environment
sudo sed -i "s/CUSTOM_DETECTOR_REFRESH_INTERVAL/${DETECTOR_REFRESH_INTERVAL}/" ${MOUNT_DIR}/etc/environment
...
case ${ROBOT_ID} in
    ...
    1) # Robot
        ...
        ;;
    2) # Ninja
        sudo sed -i "s/# PLANNER_LED_RED_PIN=/PLANNER_LED_RED_PIN=${NINJA_LED_RED_PIN}/" ${MOUNT_DIR}/etc/environment
        sudo sed -i "s/# PLANNER_LED_GREEN_PIN=/PLANNER_LED_GREEN_PIN=${NINJA_LED_GREEN_PIN}/" ${MOUNT_DIR}/etc/environment
        sudo sed -i "s/# PLANNER_LED_BLUE_PIN=/PLANNER_LED_BLUE_PIN=${NINJA_LED_BLUE_PIN}/" ${MOUNT_DIR}/etc/environment
        sudo sed -i "s/# PLANNER_FLAG_MOTOR_PIN=/PLANNER_FLAG_MOTOR_PIN=${NINJA_FLAG_MOTOR_PIN}/" ${MOUNT_DIR}/etc/environment
        sudo sed -i "s/# PLANNER_OLED_BUS=/PLANNER_OLED_BUS=${NINJA_OLED_BUS}/" ${MOUNT_DIR}/etc/environment
        sudo sed -i "s/# PLANNER_OLED_ADDRESS=/PLANNER_OLED_ADDRESS=${NINJA_OLED_ADDRESS}/" ${MOUNT_DIR}/etc/environment
        ;;
    [2-9]) # PAMIs
